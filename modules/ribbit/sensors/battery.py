## Based on work from @Scopel Emanuele
# See: https://github.com/scopelemanuele/Micropython-LC709203F/tree/master
...
# The battery sensor on the board is the LC709203F sensor.
# That sensor can be found on the main i2c bus at address 0x0xB.
...
class Battery(_base.PollingSensor):
    ...
    REG_VCELL = const(0x09)
    REG_POWER = const(0x15)
    ADDRESS = const(0x0B)
    ...
    async def _write_register(self, reg, data):
        # Create data array to hold bytes including crc
